...
public class SecurityConfig {
    ...
    /**
     * No explicit AuthenticationProvider bean: Spring Security builds a
     * DaoAuthenticationProvider automatically from the single
     * UserDetailsService (UserDetailsServiceImpl) and PasswordEncoder
     * (ApplicationConfig) beans, and wires it into this manager.
     */
    @Bean
